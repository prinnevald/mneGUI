...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(470, 0, 971, 891))
...
"text-align: right")
        ...
        self.label_2 = QtWidgets.QLabel(self.epoch)
        ...
        self.btn_findevents = QtWidgets.QPushButton(self.epoch)
        ...
        self.btn_imagemap_2 = QtWidgets.QPushButton(self.epoch)
        self.btn_imagemap_2.setGeometry(QtCore.QRect(210, 236, 201, 47))
        self.btn_imagemap_2.setStyleSheet("border: none")
        self.btn_imagemap_2.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("visual_comp/button_plotevents.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_imagemap_2.setIcon(icon5)
        self.btn_imagemap_2.setIconSize(QtCore.QSize(201, 47))
        self.btn_imagemap_2.setObjectName("btn_imagemap_2")
        self.btn_epoch = QtWidgets.QPushButton(self.epoch)
...
"text-align: right")
        ...
        self.label_10 = QtWidgets.QLabel(self.events)
        ...
        self.menu_10 = QtWidgets.QLabel(self.events)
        ...
        self.label_3 = QtWidgets.QLabel(self.events)
        ...
        self.btn_dropepochs = QtWidgets.QPushButton(self.events)
        ...
        self.btn_imagemap = QtWidgets.QPushButton(self.events)
        ...
        self.btn_tfa = QtWidgets.QPushButton(self.events)
...
"border: none;")
        ...
        self.btn_tfa1_2 = QtWidgets.QPushButton(self.evoked)
        self.btn_tfa1_2.setGeometry(QtCore.QRect(0, 246, 268, 47))
        self.btn_tfa1_2.setStyleSheet("border: none")
        self.btn_tfa1_2.setText("")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("visual_comp/button_evoked1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_tfa1_2.setIcon(icon9)
        self.btn_tfa1_2.setIconSize(QtCore.QSize(281, 47))
        self.btn_tfa1_2.setObjectName("btn_tfa1_2")
        self.btn_text_info_2 = QtWidgets.QPushButton(self.evoked)
        self.btn_text_info_2.setGeometry(QtCore.QRect(300, 246, 141, 47))
        self.btn_text_info_2.setStyleSheet("border: none")
        self.btn_text_info_2.setText("")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("visual_comp/button_evoked2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_text_info_2.setIcon(icon10)
        self.btn_text_info_2.setIconSize(QtCore.QSize(165, 47))
        self.btn_text_info_2.setObjectName("btn_text_info_2")
        self.btn_text_info_3 = QtWidgets.QPushButton(self.evoked)
        self.btn_text_info_3.setGeometry(QtCore.QRect(470, 246, 141, 47))
        self.btn_text_info_3.setStyleSheet("border: none")
        self.btn_text_info_3.setText("")
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("visual_comp/button_evoked3.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_text_info_3.setIcon(icon11)
        self.btn_text_info_3.setIconSize(QtCore.QSize(165, 47))
        self.btn_text_info_3.setObjectName("btn_text_info_3")
        self.btn_evoked_2 = QtWidgets.QPushButton(self.evoked)
        self.btn_evoked_2.setGeometry(QtCore.QRect(738, 257, 91, 21))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(16)
        font.setBold(True)
        font.setItalic(False)
        font.setWeight(75)
        self.btn_evoked_2.setFont(font)
        self.btn_evoked_2.setStyleSheet("color: rgb(0, 230, 204);\n"
"border: none;")
        self.btn_evoked_2.setObjectName("btn_evoked_2")
        self.stackedWidget.addWidget(self.evoked)
        self.side_menu = QtWidgets.QFrame(self.centralwidget)
        self.side_menu.setGeometry(QtCore.QRect(0, 0, 471, 891))
...
"}")
        ...
        self.btn_menu1.setStyleSheet("color: rgb(255, 255, 255);\n"
"border: none;\n"
"text-align: right")
...
""))
        ...
        self.btn_evoked_2.setText(_translate("MainWindow", "Train data"))
